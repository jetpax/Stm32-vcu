...
ERROR_MESSAGE_ENTRY(TIC_INIT_ERROR_TIMEOUT, ERROR_STOP) \
ERROR_MESSAGE_ENTRY(TIC_SELF_CHK_FAIL, ERROR_STOP) \
ERROR_MESSAGE_ENTRY(TIC_OVERVOLTAGE, ERROR_STOP) \
ERROR_MESSAGE_ENTRY(TIC_UNDERVOLTAGE, ERROR_DISPLAY) \
ERROR_MESSAGE_ENTRY(TIC_THERMAL_SHUTDOWN, ERROR_STOP) \
ERROR_MESSAGE_ENTRY(TIC_WETTING_CURRENT_FAIL, ERROR_DISPLAY)
